...
for message_row in cur_2 :
    ...
    # blob1 = (zlib.compress(message_row[0].encode('utf-8'), 9))
    # blob2 = (zlib.compress((message_row[1]).encode('utf-8'), 9))
    ...
    cur.execute('''INSERT OR IGNORE INTO Messages
            ...
            (guid,
             ...
             # (message_row[0]),
             # (message_row[1])
             (zlib.compress(message_row[0].encode('utf-8'), 9)),
             (zlib.compress((message_row[1]).encode('utf-8'), 9))
             ))
